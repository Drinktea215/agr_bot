...
@pytest.mark.parametrize("into, out", [
    ({
...
def test_one(into, out):
    into = SalarySchemas(**into)
    a = Agregator(dt_from=into.dt_from, dt_upto=into.dt_upto, group_type=into.group_type)
    assert a.start_aggregation() == out
